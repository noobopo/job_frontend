        ...
        <>
            <div className=' py-2 px-3 border rounded-md'>
                ...
                <div className=' flex gap-2 md:gap-0.5 lg:gap-2 mt-2'>
                    <div className=' flex text-sm justify-center tracking-tighter items-center text-purple-400 font-semibold px-0.5 h-6  w-40  border-1 rounded-md hover:bg-gray-100 border-gray-300'>{job?.position} Opening</div>
